...
GameMsg::GameMsg(MSG_TYPE _type, std::string _stream) : enMsgType(_type) {
    ...
    switch (_type)
    {
    case GameMsg::MSG_TYPE::MSG_TYPE_LOGIN_ID_NAME:
        pMsg = new pb::SyncPid();
        break;
    case GameMsg::MSG_TYPE::MSG_TYPE_CHAT_CONTENT:
        pMsg = new pb::Talk();
        break;
    case GameMsg::MSG_TYPE::MSG_TYPE_NEW_POSITION:
        pMsg = new pb::Position();
        break;
    case GameMsg::MSG_TYPE::MSG_TYPE_BROADCAST:
        pMsg = new pb::BroadCast();
        break;
    case GameMsg::MSG_TYPE::MSG_TYPE_LOGOFF_ID_NAME:
        pMsg = new pb::SyncPid();
        break;
    case GameMsg::MSG_TYPE::MSG_TYPE_SRD_POSTION:
